<?php
/**
 * Shipping methods with always-visible radio buttons.
 *
...
<tr class="woocommerce-shipping-totals shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( ! empty( $available_methods ) && is_array( $available_methods ) ) : ?>
			<p class="cxp-shipping-pick-title">Elige el envío Chilexpress</p>
			<ul id="shipping_method" class="woocommerce-shipping-methods cxp-shipping-radios">
