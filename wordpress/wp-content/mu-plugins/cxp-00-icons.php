<?php
/**
 * Plugin Name: Iconos Lucide (tienda + consola)
 * Version: 1.0.0
 * Description: Set Lucide 0.469 para la réplica. No toca chilexpress-oficial.
 */
...
function cxp_icon( $name, $class = '' ) {
	...
	$d = $paths[ $name ] ?? $paths['circle-help'];
	return '<svg class="cxp-icon ' . esc_attr( $class ) . '" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' . $d . '</svg>';
}
