...
## Laboratorio de prueba (esta app)
...
- WordPress — Automattic / colaboradores WP
- WooCommerce — Automattic
- Chilexpress Oficial 1.4.0 — Chilexpress (ZIP intacto; no se parchea en este laboratorio)
- Tema Woodmart / Woodmart Child — xtemos (réplica de la pila del cliente)
- SQLite Database Integration — WordPress.org
